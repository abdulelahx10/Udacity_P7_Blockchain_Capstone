...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner requireIsValidAddress(newOwner) {
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view requireIsValidAddress(owner) returns (uint256) {
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to, "Owner address is the same as the transfer to address");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender),
        "To approve must be either contract owner or approved by the token owner");
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _mint(address to, uint256 tokenId) internal requireIsValidAddress(to) {
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _transferFrom(address from, address to, uint256 tokenId) internal requireIsValidAddress(to) {
...
contract REToken is ERC721Metadata("Real Estate Token", "RET", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
